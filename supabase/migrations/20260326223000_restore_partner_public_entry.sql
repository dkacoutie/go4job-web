...
drop function if exists public.partner_request_apply(text, text, text, text, text, text);
drop function if exists public.partner_validate_invitation(text);
drop function if exists public.partner_admin_generate_invitation(uuid, integer);
