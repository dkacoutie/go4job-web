...
const STATIC_PAGES: Array<{ loc: string; lastmod: string; priority: string }> = [
  ...
  { loc: "/conseils-carriere", lastmod: "2026-08-13", priority: "0.6" },
  { loc: "/conseils-carriere/guide-cv-afrique-francophone", lastmod: "2026-08-13", priority: "0.5" },
  { loc: "/conseils-carriere/reussir-entretien-embauche", lastmod: "2026-08-13", priority: "0.5" },
