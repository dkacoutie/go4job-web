...
| 2026-05-03 | 15:46 | envoi réel utilisateur contrôlé | interested_no_payment_attempt | email_1 | mbo***@gmail.com | oui | oui | Delivered | sent | sent | aucun | non | troisième envoi réel utilisateur contrôlé ; dry-run worker OK juste avant ; Resend Delivered ; provider_message_id présent en DB ; lien de désinscription présent mais ne pas copier l'URL ni le token ; la mise en queue a nécessité limit=2 car limit=1 tombait sur un doublon déjà couvert | envoi enregistré ; avant tout nouvel envoi réel, refaire l'audit complet, dry-run obligatoire et limit=1 ; rester sous la limite prudente de 5 emails réels par jour ; aucun cron |
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
