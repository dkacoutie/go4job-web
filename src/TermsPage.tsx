...
export default function TermsPage() {
  ...
  return (
    <div className="app-narrow">
      ...
      <p>
        Le service vous aide à organiser vos candidatures. L'envoi effectif et le contenu final restent de votre
        responsabilité.
      </p>
      ...
      <h2>7. Résiliation</h2>
      <p>
        Vous pouvez résilier votre compte à tout moment. Go4Job se réserve le droit de suspendre ou résilier des
